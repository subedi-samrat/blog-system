...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Handle image upload
    $featured_image = $_POST['current_image']; // Keep existing image by default
    ...
    $stmt = $conn->prepare("UPDATE posts SET title = ?, slug = ?, content = ?, featured_image = ?, category_id = ?, status = ? WHERE id = ?");
    $stmt->bind_param("ssssssi", $title, $slug, $content, $featured_image, $category_id, $status, $id);
